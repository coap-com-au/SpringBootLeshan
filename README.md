[Build Status](https://coap-com-au.com/leshan/)

![Leshan](https://eclipse.org/leshan/img/multicolor-leshan.png)

[Eclipse SpringBoot Leshan™](https://coap-com-au.com/) is an OMA Lightweight M2M server and client Java implementation.
...
```bash
#using ssh
git clone git@github.com:coap-com-au/SpringBootLeshan.git
```
