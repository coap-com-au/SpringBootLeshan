        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form form-horizontal" name="form">
                        <div class={ form-group:true, has-error: endpoint.error }>
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" id="endpoint" ref="endpoint" oninput={validate_endpoint}
                                       onblur={validate_endpoint}>
                                <p class="help-block">The endpoint is required</p>
                            </div>
                        </div>

                        <ul class="nav nav-tabs nav-justified">
                            <li role="presentation" class={ active:activetab.lwserver }><a href="javascript:void(0);"
                                                                                           onclick={activetab.activelwserver}>LWM2M
                                Server</a></li>
                            <li role="presentation" class={ active:activetab.bsserver }><a href="javascript:void(0);"
                                                                                           onclick={activetab.activebsserver}>LWM2M
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" disabled={has_error()} onclick={submit}>Create
                    </button>
                </div>
            </div>
        </div>
