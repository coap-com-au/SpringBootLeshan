<rpk-input>
    ...
    <div class={ form-group:true, has-error: servpubkey.error }>
        ...
        <div class="col-sm-8">
            <textarea class="form-control" style="resize:none" rows="3" id="servpubkey" ref="servpubkey"
                      oninput={validate_servpubkey} onblur={validate_servpubkey} disabled={disable.serverpubkey}
                      placeholder={serverpubkey}></textarea>
            <p class="text-right text-muted small" style="margin:0">SubjectPublicKeyInfo der encoded in Hexadecimal</p>
